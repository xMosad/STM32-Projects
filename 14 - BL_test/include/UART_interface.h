...
*/
void UART_voidRecDataBlocking (UART_Ch_t copy_ch , u8 *copy_u8data , u8 copy_u8DataLength);

/*
  * UART_voidRecDataConditional - > receive a character if there is a character
  * I/P : UART_Ch_t   /  pointer to (u8)
*/
u8 UART_voidRecDataConditional (UART_Ch_t copy_ch , u8 *copy_u8data);
