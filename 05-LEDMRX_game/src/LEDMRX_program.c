...
void LEDMRX_voidDisplayShiftText (u8 *copy_u8Data , u16 copy_u16Time , u8 copy_u8TextSize)
{
	/* calculate how much to loop in while */
	copy_u16Time = copy_u16Time / 16;
	/* Hold the time to update it after every shift */
	u16 Local_u16Hold =copy_u16Time  ;
